...
const UserInfoUpdate = ({ userDataLoad, setUserDataLoad  }) => {
  ...
  const onSubmit = (data) => {
    ...
    const profile_picture = userImageLoad
    if (check === userNickName) {
      const userInfoChange = {
        user_id: userDataLoad.user_id,
        user_email: data.user_email,
        user_phone: data.user_phone,
        profile_picture:userDataLoad.profile_picture,
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            style={{ boder: "2px solid black" }}>
                ...
                <img className='profile_image' 
                    src={userDataLoad.profile_picture===null?Profile:"http://localhost:9150/save/"+userDataLoad.profile_picture} 
                    alt='' 
