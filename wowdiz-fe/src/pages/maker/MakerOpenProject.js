...
const MakerOpenProject = () => {
    ...
    // //form1 //table별로 묶어야하나? //배열로 처리하는게 좋은부분이 있는지 알아보자
    // const [project_name, setProject_name] = useState('');
    // const [target_amount, setTarget_amount] = useState('');
    // const [project_thumbnail, setProject_thumbnail] = useState('');
    // //const [project_summary, setProject_summary] = useState('');
    // const [project_keyword, setProject_keyword] = useState([]);
    ...
    return (
        <div className='maker_open_project'>
            <div className='maker_open_project_header'>
                <h2>{title}<div className='reward_submit_btn' onClick={onSubmit}>승인 요청하기</div></h2>
            ...
            {processSelector===1?<Form1 
                                    ...
                                    /> : 
            processSelector===2?<Form2 
                                    form={form} 
                                    setForm={setForm}
                                    handleProject={handleProject}
                                    /> : 
            processSelector===3?<Form3 
                                    form={form} 
                                    setForm={setForm}
                                    handleProject={handleProject}
