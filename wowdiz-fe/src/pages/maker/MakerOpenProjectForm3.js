    ...
    <div className="maker_open_project_form">
      <div>
        ...
        <div className="reward_wrap">
          ...
          <button className="reward_btn_reg" type="button" onClick={addReward}>
            등록
          </button>
          <button
            className="reward_btn_reset"
            type="button"
